...
use Niceshops\Core\Helper\Object\ObjectPropertyFinder;
 ...
 */
abstract class AbstractBaseBean implements BeanInterface, ArrayAccess, IteratorAggregate, Countable
{
     ...
     * @todo UnitTests
     */
    public function toArray($useOrigDataNames = true): array
    {
        if (!$useOrigDataNames) {
            return $this->data;
        }
     ...
     *
     */
    public function fromArray(array $arrData, array $arrName = null)
    {
    ...
    protected function normalizeDataName(string $name): string
    {
        ...
        $name = (new Normalizer())->normalize($name);
     ...
     * @throws BeanException
     */
    protected function normalizeDataValue_object($value)
    {
     ...
     * @return array
     */
    public function getDataType_List(): array
    {
     ...
     * @return array
     */
    public function getOriginalDataName_Map(): array
    {
        return $this->arrOriginalDataName;
    }
